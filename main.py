...
class GameView(arcade.View):
    ...
    def setup(self):
        ...
        graphics_methods.initialize_depths_array(self.depths_frame_array, 1.0, self.center, self.sprites)

        graphics_methods.animate_depths(self.depths_frame_array, 0.05)
